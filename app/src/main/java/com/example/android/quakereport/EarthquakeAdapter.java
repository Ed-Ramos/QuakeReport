...
public class EarthquakeAdapter  extends ArrayAdapter<Earthquake> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // Find the TextView in the earthquake_list_item.xmlst_item.xml layout with the ID mag_text_view
        ...
        // Find the TextView in the earthquake_list_iteme_list_item.xml layout with the ID location_text_view
       ...
       // Find the TextView in the earthquake_list_item.xmlst_item.xml layout with the ID date_text_view
